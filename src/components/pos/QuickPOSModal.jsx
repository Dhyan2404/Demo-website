...
export const QuickPOSModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Quick POS / Billing Entry"
      subtitle="Fast single-owner checkout with instant profit calculation"
      maxWidth="max-w-5xl"
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 -mx-2 sm:mx-0">
        ...
        <div className="lg:col-span-7 space-y-3">
          ...
          {/* Product Cards Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 max-h-[360px] overflow-y-auto pr-1 custom-scrollbar">
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-xl border flex flex-col justify-between transition-all select-none ${
                    inStock
                      ? 'bg-white/[0.03] hover:bg-emerald-500/10 border-white/10 hover:border-emerald-500/30 cursor-pointer active:scale-[0.98]'
        ...
        <div className="lg:col-span-5 bg-gray-950/70 border border-white/10 p-4 rounded-2xl flex flex-col justify-between space-y-4">
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11px] text-gray-400">
                        ...
                        <strong className="text-white">{formatCurrency(lineTotal, currency)}</strong>
                      </p>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`py-2 px-1 rounded-xl flex flex-col items-center gap-1 text-[11px] font-semibold border transition-all ${
                        active
                          ? m.id === 'udhaar'
          ...
          <div className="pt-3 border-t border-white/10 space-y-3">
            <div className="space-y-1.5 text-xs">
              <div className="flex justify-between text-gray-400">
                ...
                <span>{formatCurrency(cartTotals.totalCost, currency)}</span>
              </div>
              <div className="flex justify-between text-emerald-400 font-bold">
                <span className="flex items-center gap-1">
                  <TrendingUp className="w-3.5 h-3.5" /> Net Profit on this Sale:
                </span>
                <span className="text-glow-green text-sm">+{formatCurrency(cartTotals.estimatedProfit, currency)}</span>
              </div>
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-extrabold text-xs flex items-center justify-center gap-2 shadow-lg transition-all ${
                cart.items.length > 0
                  ? 'bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-gray-950 shadow-glow-green hover:scale-[1.01] active:scale-[0.98]'
