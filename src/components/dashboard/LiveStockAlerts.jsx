            ...
            {lowStockProducts.map((product) => (
              ...
              >
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 font-black text-xs flex items-center gap-1.5 transition-all shrink-0 active:scale-95"
                >
                  <RefreshCw className="w-3.5 h-3.5" />
